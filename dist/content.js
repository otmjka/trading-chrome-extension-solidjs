(function () {
  ...
  const [tradeWidgetState, setTradeWidgetState] = createStore(initValue$1);
  ...
  */
  ...
  const ShowLogItem = ({
    ...
    const showStrinify = logItem.type === "tradeEvent" || logItem.type === "tokenStatus" || logItem.type === "tokenTradeStats";
  ...
  const Content = () => {
    ...
    const [isReady, seIsReady] = createSignal(false);
    const [allSourcesReady, setAllSourcesReady] = createSignal(false);
    const [showDebug, setShowDebug] = createSignal(false);
    createEffect(() => {
      const value = !!(tradeWidgetState.tokenStatus && tradeWidgetState.tradeStats);
      console.log("### ### ###", tradeWidgetState.tokenStatus, tradeWidgetState.tradeStats, value);
    ...
    const handleSubscribe = () => {
      console.log("subscribe token", contentAppStore.mint, contentAppStore.isReady);
